...
class Dense34(torch.nn.Module):
    def __init__(self, layer_num=(2,4,6,3), growth_rate=15, init_features=30, in_channels=1, middele_channels=60, classes=5):
        super(Dense34, self).__init__()
