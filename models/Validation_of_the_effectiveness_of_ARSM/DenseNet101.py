"""DenseNet: https://github.com/StChenHaoGitHub/1D_Pytorch_Train_demo/blob/main/Models/DenseNet.py."""
...
class Dense101(torch.nn.Module):
    def __init__(self, layer_num=(6,12,14,16), growth_rate=15, init_features=30, in_channels=1, middele_channels=60, classes=5):
        super(Dense101, self).__init__()
